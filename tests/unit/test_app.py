...
def test_add_feed_duplicate_url(mock_fetch, client, setup_tabs_and_feeds):
    ...
    tab1_id = setup_tabs_and_feeds["tab1_id"]
    existing_url = "http://example.com/feed1"  # From setup_tabs_and_feeds
...
def test_add_feed_invalid_tab(
    ...
    # Use a valid URL format to pass validation
    response = client.post("/api/feeds",
                           json={
...
def test_export_opml_with_feeds(client, setup_tabs_and_feeds):
    ...
    assert feed1.get("xmlUrl") == "http://example.com/feed1"
    ...
    assert feed2.get("xmlUrl") == "http://example.com/feed2"
    ...
    assert feed3.get("xmlUrl") == "http://example.com/feed3.xml"
