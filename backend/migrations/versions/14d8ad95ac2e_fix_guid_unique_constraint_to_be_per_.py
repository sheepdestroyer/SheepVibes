...
def upgrade():
    ...
    with op.batch_alter_table('feed_items', schema=None) as batch_op:
        ...
        # Also drop any other possible remnants if naming convention was partially applied
        try:
            batch_op.drop_constraint('uq_feed_items_guid', type_='unique')
        except Exception:
            pass

        batch_op.create_unique_constraint('uq_feed_items_feed_id_guid', ['feed_id', 'guid'])
